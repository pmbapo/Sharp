...
namespace gameHorse
{
    ...
    public abstract class classGame
    {
        ...
        private int interpreter(string input)
        {
            ...
            // Call G_intHorsesLeft set -99 (This stop game next game loop.
            if (input == "stop")
            {
                G_intHorsesLeft = -99;
        ...
        private void cheat()
        {
            //if G_intHorsesLeft 1,5,9 or 13 add extra stick else default
            switch (G_intHorsesLeft)
            {
                case 1:
                case 5:
                case 9:
                case 13:
                    G_intHorsesLeft = G_intHorsesLeft + 1;
                    // using function wrtieOutput to write out to screen.
                    // (Function is abstract and there for is must be defined in parent class)
        ...
        private void gameText()
        {
            ...
            if (G_intHorsesLeft < 2) { intMaxChoice = 1; }
            else if (G_intHorsesLeft < 3) { intMaxChoice = 2; }

            // using function wrtieOutput to write out to screen.
            // (Function is abstract and there for is must be defined in parent class)
            wrtieOutput(G_strPlayers[G_intCurrentPlayer] + " Vælg antal 1 til " + intMaxChoice + ". Antal heste tilbage " + G_intHorsesLeft + ": ");
        }
        ...
        private void gameMove()
        {
            ...
            G_intHorsesLeft = G_intHorsesLeft - intChoice;
        ...
        private void gameMoveComputer()
        {
            ...
            G_intHorsesLeft = G_intHorsesLeft - intChoice; // Removing selected amount.
